                        ...
                        <div className='mb-8'> {/* Increased bottom margin */}
                            ...
                            <div className='flex items-stretch gap-2'> {/* Reduced gap */}
                                ...
                                <button
                                    ...
                                    className={`flex items-center justify-center px-4 py-3 rounded-lg text-white font-semibold transition-all duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 ${copied
